                                   ...
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
												<?php
												$i=0;
												$result = mysql_query("SELECT* FROM tbl_assetinfo INNER JOIN tbl_devicelist ON tbl_assetinfo.model_name = tbl_devicelist.model_name");			
												while($row=mysql_fetch_array($result))
												{
													$i++;
													?>
                                                    ...
                                                    <?php if($row['fitness'] == NULL) echo "<td class='text-success'>Fit</td>"; else echo "<td class='text-danger'>".$row['fitness']."</td>"; ?></td>				
